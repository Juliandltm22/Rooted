...
### *A tiny plant that grows when you take care of yourself*

![Status](https://img.shields.io/badge/status-in%20development-yellow)
![Platform](https://img.shields.io/badge/platform-iOS-lightgrey)
![Made with](https://img.shields.io/badge/made%20with-React%20Native-61DAFB?logo=react)
![Expo](https://img.shields.io/badge/built%20on-Expo-000020?logo=expo)
...
Your plant has four core needs, each mapped to a real wellness habit:

| 🌱 Plant Need | Real-Life Action | What It Tracks |
| --- | --- | --- |
| 💧 **Water** | Hydration | Log how much water you drink |
| ☀️ **Sunlight** | Daily Affirmations | Complete a short affirmation/reflection each day |
...
<div align="center">
"Even the tallest trees sprout from small seeds." — Aeschylus 🌱💧
